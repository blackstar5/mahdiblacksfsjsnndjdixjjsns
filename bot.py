...
def hasAds(msg):
	...
	links = ["rubika.ir/"] # you can develop it	for i in links:
							...
							# 	bot.sendMessage(target, "✅ قفل گیف و استیکر غیرفعال شد .", msg["message_id"])
								...
								try:
									...
									if number > 1000:
										...
										bot.sendMessage(target, "❌ ربات فقط تا 1000 پیام اخیر را پاک میکند .", msg["message_id"])
